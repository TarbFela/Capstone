 ...
 *
 * Calibration constants live in MSIF_cfg.h; they come from a bench-PSU
 * sweep against a known gas peak.
 */
...
/* Drive FMASS+ directly in QDP-pin volts. Useful for direct voltage checks
 * at the bench: bypasses the mass conversion and lets a DMM validate the
 * analog path end-to-end. Returns the clamped QDP target actually commanded. */
